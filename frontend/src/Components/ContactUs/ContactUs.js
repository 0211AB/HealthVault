...
const ContactUs = () => {
    ...
    const submitHandler = (e) => {
        ...
        emailjs.send(
            ...
            details, keys.REACT_APP_EMAILJS_USER_ID
        )
            .then((result) => {
                setDetails({
                    name: "",
        ...
        <section className="contact" id="contact">
            ...
            <div className="row">
                ...
                <div className="contact-info-container" >
                    ...
                    <div className="box">
                        <i className="fas fa-phone"><FaPhone></FaPhone></i>
                        <div className="info">
                            <h3>phone </h3>
                            <p>+123-456-7890</p>
                            <p>+111-222-3333</p>
                    ...
                    <div className="box">
                        <i className="fas fa-envelope"><FaEnvelope></FaEnvelope></i>
                        <div className="info">
                            <h3>email </h3>
                    ...
                    <div className="box">
                        <i className="fas fa-map"><FaMap></FaMap></i>
                        <div className="info">
                            <h3>address </h3>
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className="inputBox">
                        <input type="tel" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" placeholder="phone" name="phone" required onChange={changeHandler} />
                        <input type="text" placeholder="subject" name="subject" required onChange={changeHandler} />
                    </div>
                    <textarea name="text" placeholder="message" cols="30" rows="10" required onChange={changeHandler}></textarea>
