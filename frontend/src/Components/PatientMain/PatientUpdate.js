...
const PatientUpdate = () => {
    ...
    useEffect(() => {
        ...
        const sendData = async () => {
            ...
            const res = await fetch(`http://localhost:8000/api/patient/update/${data.aadharNumber}`,
                {
                    method: 'PUT',
                    body: formData,
                    headers: {
    ...
    return loading ? (<Loader></Loader>) : (
        <>
            ...
            {data === null ? <Loader /> : <section className="info-container">
                ...
                <div className="box">
                    <i className="fas fa-chalkboard-teacher"><BsCalendarDateFill /></i>
                    <div className="info">
                        <h3>Date Of Birth</h3>
            ...
            <div className="content content-update">
                <form onSubmit={submitHandler} id="form">
                    <div className="inputBox">
                        <input type="text" placeholder="Blood Group" name="bloodGroup" onChange={changeHandler} />
                        <input type="text" placeholder="Identification Marks" name="identifcationMark" onChange={changeHandler} />
                    </div>
                    <div className="inputBox">
                        <input type="text" placeholder="Height in cm" name="height" onChange={changeHandler} />
                        <input type="text" placeholder="Weight in Kg" name="weight" onChange={changeHandler} />
                    </div>
                    <div className="inputBox">
                        <input type="text" placeholder="Family Medical History" name="familyHistory" onChange={changeHandler} />
