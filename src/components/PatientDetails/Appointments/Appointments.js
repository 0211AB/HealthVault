...
const Appointments = () => {
    ...
    useEffect(() => {
        ...
        const getUserData = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}appointment/list`, {
                method: "GET",
                headers: {
    ...
    useEffect(() => {
        ...
        const deleteAppointment = async () => {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}appointment/delete`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer : ${authCtx.token}`
                        ...
                        return <SwiperSlide key={idx}>
                            <div className="swiper-slide">
                                <div className={`service-box app-box s-box${idx % 4 + 1}`}>
                                    <strong>Dr. {d.DName}</strong>
                                    <strong>Doctor ID : {d.DoctorID}</strong>
